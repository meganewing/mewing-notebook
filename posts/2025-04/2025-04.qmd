...
did enzyme comparison for lipid metabolism enzymes in a [paper](https://www.sciencedirect.com/science/article/pii/S0166445X18301462) Emma sent vs. [DEG functional annotation list](https://docs.google.com/spreadsheets/d/1rlJuEZH8cDyV6r7QpWYUu54C5h25DTrpW4ugFV3t2EA/edit?usp=sharing). None of the enzymes were shared explicitly, but other genes associated with lipid metabolism are on our list including none of the enzymes in those sections are on the DEG list, but we do have some DEGs associated with lipid metabolism: acyl-CoA dehydrogenase family member 10-like (LOC132737163), phospholipase D1-like (LOC132746792).

[light lit review](https://royalsocietypublishing.org/doi/full/10.1098/rstb.2020.0162) that really pushed my memory of biochem.
...
4/21: lecture, planning meeting, lit review / revisit methods and results (goal is to revise these sections this week in such a way that is consistent with other literature in terms of phrasing, detail, etc)
