...
Worked on DESeq and Heatmap code to 1) clean it up to make it a bit more clear and 2) refine the heatmaps for each of the analysis so far. First readthrough of the rphil manuscript (so far) too.
